...
The ImageSharp library from https://github.com/SixLabors/ImageSharp provides image processing support through the bundled Common Imaging package. It is licensed under the Apache 2 license since we are using v2 and not v3.
