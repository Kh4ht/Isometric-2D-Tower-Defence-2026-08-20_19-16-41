...
namespace AssetInventory
{
    ...
    public enum AssetImportCollisionMode
    {
        AutoRename = 0,
        WarnAndSkip = 1,
        Overwrite = 2
    ...
    [Serializable]
    public sealed class AssetInventoryTableLayout
    {
        public List<AssetInventoryColumnLayout> columns = new List<AssetInventoryColumnLayout>();
        public List<AssetInventorySortLayout> sorting = new List<AssetInventorySortLayout>();
    }

    [Serializable]
    public sealed class AssetInventoryColumnLayout
    {
        public string key;
        public float width;
        public bool visible;
    ...
    [Serializable]
    public sealed class AssetInventorySortLayout
    {
        public string key;
    ...
    internal static class SearchScopeModel
    {
        public static SearchScope[] GetToolbarScopes(bool showIndexScope)
        {
            return showIndexScope
                ? new[] {SearchScope.All, SearchScope.Project, SearchScope.Index}
                : new[] {SearchScope.All, SearchScope.Project};
        }

        public static SearchScope Normalize(int searchScope, bool showIndexScope)
        {
            if (!Enum.IsDefined(typeof(SearchScope), searchScope)) return SearchScope.All;
            return Normalize((SearchScope)searchScope, showIndexScope);
        }

        public static SearchScope Normalize(SearchScope searchScope, bool showIndexScope)
        {
            if (searchScope == SearchScope.Index && !showIndexScope) return SearchScope.All;
            return searchScope;
        }

        public static bool UsesIndexSearch(SearchScope searchScope)
        {
            return searchScope == SearchScope.All || searchScope == SearchScope.Index;
        }

        public static bool UsesProjectSearch(SearchScope searchScope)
        {
            return searchScope == SearchScope.All;
        }

        public static bool IsProjectOnly(SearchScope searchScope)
        {
            return searchScope == SearchScope.Project;
        }

        public static bool ShouldAutoCalculateAssetUsage(SearchScope searchScope)
        {
            return searchScope == SearchScope.All || searchScope == SearchScope.Project;
        }

        public static bool UsesCodeIndexSearch(SearchScope searchScope)
        {
            return searchScope == SearchScope.All || searchScope == SearchScope.Index;
        }

        public static bool UsesCodeProjectSearch(SearchScope searchScope)
        {
            return searchScope == SearchScope.All || searchScope == SearchScope.Project || searchScope == SearchScope.Index;
        }
    }
    ...
    public sealed class AssetInventorySettings
    {
        ...
        public int searchScope = 2; // 0 = All (Index + Project), 1 = Project Only, 2 = Index Only
        ...
        public int maxProjectSearchResults = 5000;
        ...
        public bool showIndexSearchScope = true;
        ...
        public string excludedExtensions = "asset;json;shadersubgraph;txt;cs;md;md5;uss;asmdef;uxml;editorconfig;signature;yml;cginc;gitattributes;release;collabignore;suo;ds_store;asmref;hlsl;shaderinclude;hlslinc;vfxoperator;vfxblock;shadervariants;sgsubgraphdb;preset;signal;template;scenetemplate;modulecompilationtrigger;api;url;bytes;yaml;xml;gitignore;npmignore;lock;log;tmp;bak;orig;user;csproj;sln;pdb;mdb;rsp;props;targets;ruleset;dll;so;dylib;bundle;jar;aar;jslib;cpp;c;h;hpp;mm;swift;java;kt;gradle;properties;plist;xcprivacy";
        public string customSearchTypeExtensions;
        ...
        public AssetInventoryTableLayout packageTableLayout;
        public AssetInventoryTableLayout searchTableLayout;
        public AssetInventoryTableLayout reportTableLayout;

        public bool showSearchSideBar = true;
        public bool showSearchHierarchySideBar;
        public bool showPackageSideBar = true;
        public float searchHierarchySideBarWidth = 230f;
        public float searchInspectorWidth = 300f;
        public float packageInspectorWidth = 300f;
        public int searchLeftSideBarHierarchy; // 0=Path, 1=Category, 2=Publisher, 3=Package, 4=Type, 5=Filters
        ...
        public bool showActionSettings = true;
        ...
        public bool onlyInProject; // legacy, migrated to scope
        ...
        public bool noIndexByDefault;
        public bool extractByDefault;
        public bool captionByDefault;
        public bool useUnityPipelineConverter; // use Unity's built-in converter (BIRP→URP only, requires USE_URP)
        ...
        public bool aiCaptionsFeatureEnabled;
        public string aiCaptionExtensions = "{prefabs}";
        ...
        public bool semanticSearchFeatureEnabled;
        public string semanticIndexFolder;
        public int semanticSearchMode = 2; // 0 = Exact, 1 = Semantic, 2 = Hybrid
        public bool semanticIndexAssets = true;
        public bool semanticIndexCode;
        public bool semanticIndexByDefault = true;
        public string semanticIndexExtensions = "{images};{prefabs};{materials};{models};{animations};{effects};{audio};{videos};{fonts}";
        public bool codeIndexProjectFiles = true;
        public bool codeSearchFeatureEnabled;
        public bool codeIndexPackageFiles = true;
        public bool codeIndexByDefault = true;
        public bool codeIndexAutoUpdateProjectChanges = true;
        public bool codeIndexSemanticRerank;
        public string codeIndexExtensions = "{scripts};{shaders};asmdef;asmref;uxml;uss;json;yaml;yml;xml;md;cginc;hlsl;shaderinclude";
        public int codeIndexMaxFileSizeKb = 1024;
        public string semanticOllamaEmbeddingModel = "embeddinggemma";
        public string semanticLmStudioEmbeddingModel = "";
        public int semanticEmbeddingBatchSize = 16;
        public int semanticCandidateLimit = 10000;
        public int semanticResultLimit = 500;
        public float semanticMinScore = 0.15f;
        public int semanticAccelerator = 0; // 0 = Auto, 1 = Standard only, 2 = Fast cache
        public int hnswMinVectorCount = 20000;
        public float hnswRebuildTombstoneRatio = 0.05f;
        ...
        public float cpParticleMinimumVisibleDuration;
        public float cpVFXMinimumVisibleDuration;
        ...
        public bool forceInitOnDomainReload;
        ...
        public bool packageBackupFeatureEnabled;
        ...
        public AssetImportCollisionMode importCollisionMode = AssetImportCollisionMode.AutoRename;
        ...
        public bool welcomeShown; // legacy serialized welcome marker retained for compatibility
