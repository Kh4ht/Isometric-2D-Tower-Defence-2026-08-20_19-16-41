...
{
    /// <summary>Finds duplicate unassigned media records after the same files become associated with a package.</summary>
    public sealed class ReassignedMediaIndexValidator : Validator
    {
        ...
        private async Task<List<AssetInfo>> GatherReassignedMediaIndexes()
        {
        ...
        private async Task RemoveReassignedMediaIndexes(List<AssetInfo> duplicates)
        {
            int progress = 0;
