...
{
    /// <summary>Finds indexed files that should have a preview but no preview file exists.</summary>
    public sealed class MissingPreviewFilesValidator : Validator
    {
        ...
        private async Task<List<AssetInfo>> GatherIssues()
        {
