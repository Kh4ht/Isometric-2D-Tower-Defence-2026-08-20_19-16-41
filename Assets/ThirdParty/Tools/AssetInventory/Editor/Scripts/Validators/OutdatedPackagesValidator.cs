...
{
    /// <summary>Finds obsolete cached Asset Store package copies left behind after publisher metadata changed their storage path.</summary>
    public sealed class OutdatedPackagesValidator : Validator
    {
        ...
        public override async Task Fix()
        {
            ...
            foreach (AssetInfo issue in DBIssues)
            {
                ...
                Assets.RemovePackage(issue, true);
                await Task.Yield();
            }
