...
{
    /// <summary>Serializable Asset Store origin metadata used to stamp imported files with their product, package, version, and upload identity.</summary>
    [Serializable]
    public sealed class AssetOrigin
    {
        ...
        /// <summary>Creates Asset Store origin metadata from the supplied product, package, version, and upload identifiers.</summary>
        ...
        /// <summary>Creates Unity's editor asset-origin object when that API is available, or returns null on unsupported Unity versions.</summary>
