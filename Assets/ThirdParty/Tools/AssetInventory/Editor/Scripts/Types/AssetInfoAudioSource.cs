...
namespace AssetInventory
{
    ...
    public class AssetInfoAudioSource : IAudioSource
    {
        ...
        /// <summary>Creates an audio source adapter that materializes and opens the supplied indexed audio file on demand.</summary>
        ...
        /// <summary>Ensures the indexed audio file is available locally and returns its usable path, honoring cancellation.</summary>
