...
{
    /// <summary>Describes one configured source folder, its scan rules, and how discovered content is classified and indexed.</summary>
    [Serializable]
    public sealed class FolderSpec
    {
        ...
        /// <summary>Creates a source-folder specification rooted at the supplied filesystem location.</summary>
        public FolderSpec(string location)
        {
            this.location = location;
        }

        /// <summary>Creates an independent copy of the supplied source-folder specification.</summary>
        ...
        /// <summary>Returns the configured source path after optional variable expansion and platform normalization.</summary>
