...
{
    /// <summary>Defines a named custom metadata field, its value type, visibility, display order, and available list values.</summary>
    [Serializable]
    public sealed class MetadataDefinition
    {
        ...
        /// <summary>Creates a metadata field definition with the supplied display name and default value type.</summary>
