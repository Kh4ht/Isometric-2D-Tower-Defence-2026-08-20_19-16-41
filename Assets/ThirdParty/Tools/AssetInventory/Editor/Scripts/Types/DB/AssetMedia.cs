...
{
    /// <summary>Persistent media attachment for a package, including its remote URL, cached path, preview identity, dimensions, and duration.</summary>
    [Serializable]
    public class AssetMedia
    {
        ...
        [Ignore] public bool DownloadFailed { get; set; }
        [Ignore] public Texture2D ThumbnailTexture { get; set; }
        [Ignore] public Texture2D Texture { get; set; }

        /// <summary>Returns the media item's original URL or cached local URL according to the requested preference.</summary>
