...
{
    /// <summary>Per-package overrides for identity, display metadata, compatibility, location, indexing, and update behavior.</summary>
    [Serializable]
    public sealed class PackageOverrides
    {
        ...
        public bool bIRPCompatible;
        public bool hDRPCompatible;
        public bool uRPCompatible;
