...
{
    /// <summary>Loads indexed files from a saved file search into the Automator action context.</summary>
    [Serializable]
    public sealed class LoadFilesStep : ActionStep
    {
        ...
        /// <summary>Loads indexed files from the configured saved search and replaces, adds to, or subtracts from the current action context.</summary>
        ...
        /// <summary>Returns saved file searches as selectable load options.</summary>
