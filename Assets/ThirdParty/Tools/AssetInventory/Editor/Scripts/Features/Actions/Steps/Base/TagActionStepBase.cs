...
{
    /// <summary>Base Automator step for assigning or removing a configured tag from the packages or files in the current action context.</summary>
    [Serializable]
    public abstract class TagActionStepBase : ActionStep
    {
        ...
        /// <summary>Applies or removes the configured tag from the packages or files in the current Automator action context.</summary>
