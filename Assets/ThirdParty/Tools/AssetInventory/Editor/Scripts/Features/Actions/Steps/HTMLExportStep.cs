...
{
    /// <summary>Exports the catalog to a target folder using a selected HTML template.</summary>
    [Serializable]
    public sealed class HTMLExportStep : ActionStep
    {
        ...
        /// <summary>Exports the catalog with the selected HTML template into the configured target directory.</summary>
        ...
        /// <summary>Returns installed export templates as selectable values for the template action parameter.</summary>
