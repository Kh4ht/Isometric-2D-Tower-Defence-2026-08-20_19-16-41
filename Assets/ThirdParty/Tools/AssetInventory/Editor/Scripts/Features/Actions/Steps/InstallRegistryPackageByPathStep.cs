...
{
    /// <summary>Adds a Unity registry package from a local path, Git URL, tarball, or package URL to the open project.</summary>
    [Serializable]
    public sealed class InstallRegistryPackageByPathStep : ActionStep
    {
        ...
        /// <summary>Adds the configured local, Git, tarball, or package URL dependency to the open project and waits for Package Manager completion.</summary>
