...
namespace AssetInventory
{
    ...
    public sealed class AssetInventoryActionContext : DictionaryActionContext
    {
        ...
        public static void SetLoadedAssets(List<AssetInfo> assets, LoadAssetsStep.AssetOperation operation)
        {
            ...
            if (context == null)
            {
                throw new Exception("No active AssetInventoryActionContext. SetLoadedAssets can only be called during action execution.");
            }
        ...
        public static void SetLoadedFiles(List<AssetInfo> files, LoadFilesStep.FileOperation operation)
        {
            ...
            if (context == null)
            {
                throw new Exception("No active AssetInventoryActionContext. SetLoadedFiles can only be called during action execution.");
            }
