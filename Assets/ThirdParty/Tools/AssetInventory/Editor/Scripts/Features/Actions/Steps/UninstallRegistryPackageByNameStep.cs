...
{
    /// <summary>Removes a named direct Unity registry package dependency from the open project.</summary>
    [Serializable]
    public sealed class UninstallRegistryPackageByNameStep : ActionStep
    {
        ...
        /// <summary>Removes the configured direct registry dependency from the open project's package manifest.</summary>
