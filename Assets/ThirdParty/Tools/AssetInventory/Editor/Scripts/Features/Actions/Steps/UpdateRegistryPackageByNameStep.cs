...
{
    /// <summary>Updates a named Unity registry package in the open project to the requested version.</summary>
    [Serializable]
    public sealed class UpdateRegistryPackageByNameStep : ActionStep
    {
        ...
        /// <summary>Updates the configured registry package to the requested version and waits for Package Manager completion.</summary>
