...
{
    /// <summary>Adds a named Unity registry package and optional version to the open project's manifest.</summary>
    [Serializable]
    public sealed class InstallRegistryPackageByNameStep : ActionStep
    {
        ...
        /// <summary>Adds the configured registry package and optional version to the open project and waits for Package Manager completion.</summary>
