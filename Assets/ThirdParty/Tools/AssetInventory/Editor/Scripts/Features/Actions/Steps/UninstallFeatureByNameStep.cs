...
{
    /// <summary>Removes a named Unity feature package and its unlocked dependencies from the open project.</summary>
    [Serializable]
    public sealed class UninstallFeatureByNameStep : ActionStep
    {
        ...
        /// <summary>Removes the configured Unity feature package and its unlocked dependencies from the open project.</summary>
