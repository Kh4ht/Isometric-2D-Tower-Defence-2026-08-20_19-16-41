...
{
    /// <summary>Loads packages from a package-type filter or saved search into the Automator action context.</summary>
    [Serializable]
    public sealed class LoadAssetsStep : ActionStep
    {
        ...
        /// <summary>Loads packages matching the configured filter and replaces, adds to, or subtracts from the current action context.</summary>
        ...
        /// <summary>Returns package-type filters and saved package searches as selectable load options.</summary>
