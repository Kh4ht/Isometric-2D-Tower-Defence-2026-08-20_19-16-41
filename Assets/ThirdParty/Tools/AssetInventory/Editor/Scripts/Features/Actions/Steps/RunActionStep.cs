...
{
    /// <summary>Invokes another predefined or saved Automator action from the current workflow.</summary>
    [Serializable]
    public sealed class RunActionStep : ActionStep
    {
        ...
        /// <summary>Returns visible predefined and saved actions as selectable nested-action values.</summary>
        ...
        /// <summary>Shows the force option only when the selected nested action supports bypassing its recent-execution guard.</summary>
        ...
        /// <summary>Invokes the selected predefined or saved Automator action and optionally bypasses its recent-execution guard.</summary>
