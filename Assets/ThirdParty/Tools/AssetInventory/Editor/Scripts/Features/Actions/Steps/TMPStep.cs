...
{
    /// <summary>Imports the selected TextMeshPro essential resources or examples into the open Unity project.</summary>
    [Serializable]
    public sealed class TMPStep : ActionStep
    {
        ...
        /// <summary>Reports whether the standard TextMeshPro essential resources folder exists in the open project.</summary>
        ...
        /// <summary>Imports essentials into the catalog or open Unity project using the configured collision and dependency rules.</summary>
        ...
        /// <summary>Imports the selected TextMeshPro essential resources or examples, failing when the TextMeshPro package is not installed.</summary>
        ...
        /// <summary>Returns the installed TextMeshPro package directory, or null when the package is unavailable.</summary>
