...
{
    /// <summary>Writes the packages in the current Automator action context to a CSV file using the saved CSV export settings.</summary>
    [Serializable]
    public sealed class CSVExportStep : ActionStep
    {
        ...
        /// <summary>Writes the packages in the current action context to the configured CSV file and waits until the file is complete.</summary>
