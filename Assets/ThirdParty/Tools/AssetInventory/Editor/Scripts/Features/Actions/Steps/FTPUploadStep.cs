...
{
    /// <summary>Uploads a local directory tree to a configured FTP or SFTP destination.</summary>
    [Serializable]
    public sealed class FTPUploadStep : FTPActionStep
    {
        ...
        /// <summary>Connects to the configured FTP or SFTP server and uploads the selected local directory tree to the remote target.</summary>
