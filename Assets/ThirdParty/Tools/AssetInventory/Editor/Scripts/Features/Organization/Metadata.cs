...
namespace AssetInventory
{
    ...
    public static partial class Metadata
    {
        ...
        /// <summary>Loads metadata field definitions in their configured display order.</summary>
        ...
        /// <summary>Creates and persists a metadata field definition after validating its name and type.</summary>
        ...
        /// <summary>Deletes a metadata definition and its assignments after the caller confirms that destructive operation.</summary>
        ...
        /// <summary>Assigns the selected metadata definition and value to a package or indexed file, replacing an existing value for the same definition.</summary>
        ...
        /// <summary>Removes the selected metadata value from its package or file target without deleting the field definition.</summary>
        ...
        /// <summary>Returns resolved metadata values for the selected package keyed by definition.</summary>
        ...
        /// <summary>Returns metadata field values currently configured as file-path hide patterns.</summary>
